  ...
  <a-layout class="layout">
    <a-layout-header class="app-header">
      ...
      <a-menu
        ...
        @select="selectMenu"
      >
        <a-menu-item key="/"><span  class="app-menu-title">市场行情</span></a-menu-item>
        <a-menu-item key="/information" class="app-menu-title"><span  class="app-menu-title">知识资讯</span></a-menu-item>
        <a-menu-item key="/buy" class="app-menu-title"><span  class="app-menu-title">我要买货</span></a-menu-item>
        <a-menu-item key="/sell" class="app-menu-title"><span  class="app-menu-title">我要卖货</span></a-menu-item>
        <a-menu-item key="/chat" class="app-menu-title"><span  class="app-menu-title">我要聊天</span></a-menu-item>
        <a-sub-menu key="/login" class="app-menu-login" style="margin-left: auto;" >
            <template #title>
              <span>
                <UserOutlined />
                subnav 2
            ...
            <a-menu-item key="5">修改信息</a-menu-item>
